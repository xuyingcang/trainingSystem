...
<form style="margin-left: 70px" class="layui-form" method="post" action="../../addPerson.do">
    ...
    <div style="margin-top: 10px;" class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="sex"  style="height: 35px;width:190px;border-color: #D2D2D2">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="person_type" style="height: 35px;width:190px;border-color: #D2D2D2">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="height" class="layui-input" type="text" placeholder="身高单位cm" autocomplete="off"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="weight" class="layui-input" type="text" placeholder="体重单位kg" autocomplete="off"
                       lay-verify="required|number">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="military_rank" class="layui-input" type="text" placeholder="请选择" autocomplete="off"
                       lay-verify="required">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="duty" class="layui-input" type="text" placeholder="请输入职务" autocomplete="off"
                       lay-verify="required"   >
            </div>
        </div>
    </div>
 <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="profession" class="layui-input" type="text" placeholder="请输入专业" autocomplete="off"
                       lay-verify="required">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="training_type" class="layui-input" type="text" placeholder="请输入训练类型" autocomplete="off"
                       lay-verify="required">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div style="margin-left: 400px" class="layui-input-block">
            <button class="layui-btn" lay-submit lay-filter="formDemo" onclick="uploadPlan()">添加</button>
