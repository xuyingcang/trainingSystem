...
<script type="text/javascript" src="addExamPlan.js"></script>
...
<body>
<form style="margin-left: 70px" id="form-examplan" class="layui-form" method="post" onsubmit="myExamPlanAction()">

    <div style="margin-top: 10px;" class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">考核内容</label>
            <div class="layui-input-inline">
                <input name="content" class="layui-input" type="text" placeholder="请输入考试内容" autocomplete="off"
                       lay-verify="required">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="time" id="birthday" class="layui-input" type="text" placeholder="请选择日期" lay-verify="required|date" >
                <%--设置日期框--%>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="type" class="layui-input" type="text" placeholder="" autocomplete="off"
                       lay-verify="required">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="percent" class="layui-input" type="text" placeholder="" autocomplete="off"
